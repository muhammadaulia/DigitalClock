...
function currentTime(params) {
    ...
    hour = hour < 10 ? "0" + hour : hour; /* Kalau waktu kurang dari 10 (2 angka) maka beri "0" sebelum waktu, contoh: 2 (1 angka) maka ditampilkan menjadi 02 */
...
currentTime(); /* calling the function to start the process */